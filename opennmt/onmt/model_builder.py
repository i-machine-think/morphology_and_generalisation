...
def build_base_model(model_opt, fields, gpu, checkpoint=None, gpu_id=None, vocab=None):
...
def build_model(model_opt, opt, fields, checkpoint, vocab):
    logger.info('Building model...')
    model = build_base_model(model_opt, fields, use_gpu(opt), checkpoint, vocab=vocab)
    logger.info(model)
    return model
